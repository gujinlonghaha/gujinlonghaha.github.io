 ...
 **上面操作是不是很给力 一个小技巧可以使你的命令  体验更简单、容易、熟悉：别名** 

 **同事看到你的命令 工作流时，总是充满了惊讶与好奇：** 
...
```
 ...
 这意味着，当要输入 `git commit` 时，只需要输入 `git ci`。 随着你继续不断地使用可能也会经常使用其他命令，所以创建别名时不要犹豫。
